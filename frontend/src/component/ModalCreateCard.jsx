        ...
        <div className="bg-white p-6 rounded shadow-lg z-50">
            ...
            <form onSubmit={handleCreateCard} className="site-create rounded-lg p-6">
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <button className='bg-[#4CAE50] hover:bg-green-400 text-white font-bold h-10 w-24 justify-center border-b-4 border-green-700 hover:border-green-500 rounded flex items-center gap-x-2'>
